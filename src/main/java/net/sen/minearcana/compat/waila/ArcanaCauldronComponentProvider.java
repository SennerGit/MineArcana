...
public enum ArcanaCauldronComponentProvider implements IBlockComponentProvider, IServerDataProvider<BlockAccessor> {
    ...
    public void appendTooltip(ITooltip tooltip, BlockAccessor accessor, IPluginConfig config) {
        ...
        int minTemp = serverData.getInt(TEMPERATURE_MIN_TAG);
        ...
        tooltip.add(Component.literal("Min Temperature: " + minTemp + "°C"));
    ...
    public void appendServerData(CompoundTag tag, BlockAccessor accessor) {
        if (accessor.getBlockEntity() instanceof ArcanaCauldronBlockEntity be) {

            // Temperature values
            tag.putInt(TEMPERATURE_TAG, be.getTemperature());
            tag.putInt(TEMPERATURE_BASE_TAG, be.getBaseTemperature());
            tag.putInt(TEMPERATURE_MIN_TAG, be.getMinTemperature());
            tag.putInt(TEMPERATURE_MAX_TAG, be.getMaxTemperature());
            ...
            // Aspects
            List<AspectStack> aspects = be.getAspects();
            if (!aspects.isEmpty()) {
